...
$combinado_estandar = (object) array(
            ...
            "producto_uso_recomendado" => $product_multiplier * $base_qty_euf . " ampollas + " . 
                                          $base_qty_hp . " ampollas al mes",
            "producto_precio" => set_precio_str($product_multiplier, 'euf', 'hp'),
            "producto_precio_descuento" => set_precio_str($product_multiplier, 'euf', 'hp', $porcentaje_descuento),
            "producto_precio_solo" => set_precio_str($product_multiplier, 'euf', ''),
            "producto_precio_solo_descuento" => set_precio_str($product_multiplier, 'euf', '', $porcentaje_descuento),
            ...
            rawurlencode("Paquete Combinado Estandar:<br/>Eco UltraFiltrados" . $euf_type . 
			 ...
			 $base_qty_hp . " ampollas MFIII HP)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'euf', 'hp') .
            $delimiter .
            $quantity .
            $delimiter .
            $delimiter .
