...
$quantity   = 1;
$discount   = "<br/>(With " . round((1 - $porcentaje_descuento) * 100) . "% discount!)";
$box_use    = "<br/>(Capsules without box)";
$discount_description   = "";
$product_to_combine     = "blue_cell";
$euf_type   = euf_type_from_cookie();

//Cantidades base para los productos:
$base_qty_euf       = 2;    //vials
$base_qty_hp        = 4;    //vials
$base_qty_vpvials   = 1;    //vials
...
$combinado_estandar = (object) array(
            ...
            "imagen_ancho" => 160,
            "imagen_alto" => 160,
            "producto_tipo" => "Combined Standard Package",
            "producto_nombre" => "Eco-UltraFiltrates + MFIII HP",
            "producto_tipo_terapia" => "Inyectable and drinkable Therapy",
            "producto_uso_recomendado"  => $product_multiplier * $base_qty_euf . " vials + " . 
                                           $product_multiplier * $base_qty_hp . " vials a month",
            ...
            $delimiter .
            rawurlencode("Combined Standard Package:<br/>Eco-UltraFiltrates" . $euf_type . 
                         "<br>(" . $product_multiplier * $base_qty_euf . " vials + " . 
			 $product_multiplier * $base_qty_hp . " MFIII HP vials)" . 
                         $discount_description) .
            $delimiter .
...
$separado_estandar_1 = (object) array(
            ...
            "imagen_ancho" => 160,
            "imagen_alto" => 160,
            "producto_tipo" => "Standard Package",
            "producto_nombre" => "Eco-UltraFiltrates",
            "producto_tipo_terapia" => "Drinkable Therapy",
            "producto_uso_recomendado" => $product_multiplier * $base_qty_euf . " vials a month",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Drinkable Standard Package:<br>Eco-UltraFiltrates" . $euf_type . "<br>(" . $product_multiplier * $base_qty_euf . " vials)" . $discount_description) .
            $delimiter .
...
$separado_estandar_2 = (object) array(
            ...
            "producto_tipo_terapia" => "Inyectable Therapy",
            "producto_uso_recomendado" => $product_multiplier * $base_qty_hp . " vials a month",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Inyectable Standard Package:<br>MFIII HP<br>(" . $product_multiplier * $base_qty_hp . " vials)" . $discount_description) .
            $delimiter .
...
$separado_estandar_3 = (object) array(
            ...
            "producto_tipo_terapia" => "Inyectable Therapy",
            "producto_uso_recomendado" => $product_multiplier * $base_qty_vpvials . " vial a month",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Inyectable Standard Package:<br>MFIII Vegetal Placenta<br>(" . $product_multiplier * $base_qty_vpvials . " vial)" . $discount_description) .
            $delimiter .
...
$separado_estandar_4 = (object) array(
            ...
            "producto_tipo_terapia" => "Capsules Therapy",
            "producto_uso_recomendado" => $product_multiplier * $base_qty_pe . " capsules a month",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Capsules Standard Package:<br>" . $product_multiplier . 
                         " MFIII PE" . $box_use . $discount_description) .
            $delimiter .
...
$ideal_estandar = (object) array(
            ...
            "imagen_ancho" => 160,
            "imagen_alto" => 160,
            "producto_tipo" => "Ideal Standard Package",
            "producto_nombre" => "Eco-UltraFiltrates",
            "producto_tipo_terapia" => "Drinkable Therapy",
            "producto_uso_recomendado" => $product_multiplier * $ideal_qty_euf . 
                                            " vials (" . $product_multiplier . 
                                            " whole box)",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Ideal Standard Package:<br>Eco-UltraFiltrates" . $euf_type . 
                         "<br>(" . $product_multiplier * $ideal_qty_euf . 
                         " vials)" . $discount_description) .
            $delimiter .
...
$combinado_premium = (object) array(
            ...
            "imagen_ancho" => 160,
            "imagen_alto" => 160,
            "producto_tipo" => "Combined Premium Package",
            "producto_nombre" => "Eco-UltraFiltrates + MFIII HP",
            "producto_tipo_terapia" => "Inyectable and drinkable Therapy",
            "producto_uso_recomendado"  => $product_multiplier * $base_qty_euf . " vials + " . 
                                           $product_multiplier * $base_qty_hp . " vials a month",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Combined Premium Package:<br/>Eco-UltraFiltrates" . $euf_type . 
                         "<br>(" . $product_multiplier * $base_qty_euf . " vials + " . 
			 $product_multiplier * $base_qty_hp . " MFIII HP vials)" . 
                         $discount_description) .
            $delimiter .
...
$separado_premium_1 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Drinkable Premium Package:<br>Eco-UltraFiltrates" . $euf_type . "<br>(" . $product_multiplier * $base_qty_euf . " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'euf', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$separado_premium_2 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Inyectable Premium Package:<br>MFIII HP<br>(" . $product_multiplier * $base_qty_hp . " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'hp', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$separado_premium_3 = (object) array(
            ...
            "producto_nombre" => "MFIII Vegetal Placenta",
            "producto_tipo_terapia" => "Inyectable Therapy",
            "producto_uso_recomendado" => $product_multiplier * $base_qty_vpvials . " vials a month",
            "producto_precio" => set_precio_str($product_multiplier, 'vpamps'),
            "producto_precio_descuento" => set_precio_str($product_multiplier, 'vpamps', '', $porcentaje_descuento),
            "producto_peso" => set_peso($product_multiplier, 1, $product_to_combine),
            "usar_select" => "vp_vials",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Inyectable Premium Package:<br>MFIII Vegetal Placenta<br>(" . $product_multiplier * $base_qty_vpvials . " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'vpamps', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$separado_premium_4 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Capsules Premium Package:<br>" . $product_multiplier . 
                         " MFIII PE" . $box_use . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'pe', '', $porcentaje_descuento) .
            $delimiter .
...
$ideal_premium = (object) array(
            ...
            "imagen_ancho" => 160,
            "imagen_alto" => 160,
            "producto_tipo" => "Ideal Premium Package",
            "producto_nombre" => "Eco-UltraFiltrates",
            "producto_tipo_terapia" => "Drinkable Therapy",
            "producto_uso_recomendado" => $product_multiplier * $ideal_qty_euf . " vials (" . $product_multiplier . " whole boxes)",
            "producto_precio" => set_precio_str($product_multiplier, 'idealeuf'),
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Ideal Premium Package:<br>Eco-UltraFiltrates" . $euf_type . 
                         "<br>(" . $product_multiplier * $ideal_qty_euf . 
                         " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'idealeuf', '', $porcentaje_descuento) .
...
$combinado_optimum = (object) array(
            ...
            "imagen_ancho" => 160,
            "imagen_alto" => 160,
            "producto_tipo" => "Combined Optimum Package",
            "producto_nombre" => "Eco-UltraFiltrates + MFIII HP",
            "producto_tipo_terapia" => "Inyectable and drinkable Therapy",
            "producto_uso_recomendado"  => $product_multiplier * $base_qty_euf . " vials + " . 
                                           $product_multiplier * $base_qty_hp . " vials a month",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Combined Optimum Package:<br/>Eco-UltraFiltrates" . $euf_type . 
                         "<br>(" . $product_multiplier * $base_qty_euf . " vials + " . 
			 $product_multiplier * $base_qty_hp . " MFIII HP vials)" . 
                         $discount_description) .
            $delimiter .
...
$separado_optimum_1 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Drinkable Optimum Package:<br>Eco-UltraFiltrates" . $euf_type . "<br>(" . $product_multiplier * $base_qty_euf . " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'euf', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$separado_optimum_2 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Inyectable Optimum Package:<br>MFIII HP<br>(" . $product_multiplier * $base_qty_hp . " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'hp', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$separado_optimum_3 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Inyectable Optimum Package:<br>MFIII Vegetal Placenta<br>(" . $product_multiplier * $base_qty_vpvials . " vial)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'vpamps', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$separado_optimum_4 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Optimum Package en Capsulas:<br>" . $product_multiplier . 
                         " MFIII PE" . $box_use . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'pe', '', $porcentaje_descuento) .
            $delimiter .
...
$ideal_optimum = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Ideal Optimum Package:<br>Eco-UltraFiltrates" . $euf_type . 
                         "<br>(" . $product_multiplier * $ideal_qty_euf . 
                         " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'idealeuf', '', $porcentaje_descuento) .
...
$combinado_optimum_plus = (object) array(
            ...
            "imagen_ancho" => 160,
            "imagen_alto" => 160,
            "producto_tipo" => "Combined Optimum Plus Package",
            "producto_nombre" => "Eco-UltraFiltrates + MFIII HP",
            "producto_tipo_terapia" => "Inyectable and drinkable Therapy",
            "producto_uso_recomendado"  => $product_multiplier * $base_qty_euf . " vials + " . 
                                           $product_multiplier * $base_qty_hp . " vials a month",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Combined Optimum Plus Package:<br/>Eco-UltraFiltrates" . $euf_type . 
                         "<br>(" . $product_multiplier * $base_qty_euf . " vials + " . 
			 $product_multiplier * $base_qty_hp . " MFIII HP vials)" . 
                         $discount_description) .
            $delimiter .
...
$separado_optimum_plus_1 = (object) array(
            ...
            "imagen_ancho" => 160,
            "imagen_alto" => 160,
            "producto_tipo" => "Optimum Plus Package",
            "producto_nombre" => "Eco-UltraFiltrates",
            "producto_tipo_terapia" => "Drinkable Therapy",
            "producto_uso_recomendado" => $product_multiplier * $base_qty_euf . " vials a month",
            "producto_precio" => set_precio_str($product_multiplier, 'euf'),
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Drinkable Optimum Plus Package:<br>Eco-UltraFiltrates" . $euf_type . "<br>(" . $product_multiplier * $base_qty_euf . " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'euf', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$separado_optimum_plus_2 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Inyectable Optimum Plus Package:<br>MFIII HP<br>(" . $product_multiplier * $base_qty_hp . " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'hp', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$separado_optimum_plus_3 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Inyectable Optimum Plus Package:<br>MFIII Vegetal Placenta<br>(" . $product_multiplier * $base_qty_vpvials . " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'vpamps', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$separado_optimum_plus_4 = (object) array(
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Capsules Optimum Plus Package:<br>" . $product_multiplier . " MFIII PE" . $box_use . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'pe', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$ideal_optimum_plus = (object) array(
            ...
            "imagen_ancho" => 160,
            "imagen_alto" => 160,
            "producto_tipo" => "Ideal Optimum Plus Package",
            "producto_nombre" => "Eco-UltraFiltrates",
            "producto_tipo_terapia" => "Drinkable Therapy",
            "producto_uso_recomendado" => $product_multiplier * $ideal_qty_euf . " vials (" . $product_multiplier . " whole boxes)",
            "producto_precio" => set_precio_str($product_multiplier, 'idealeuf'),
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Ideal Optimum Plus Package:<br>Eco-UltraFiltrates" . $euf_type . 
                         "<br>(" . $product_multiplier * $ideal_qty_euf . 
                         " vials)" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'idealeuf', '', $porcentaje_descuento) .
...
$producto6_1 = (object) array(
            ...
            "imagen_ancho" => 150,
            "imagen_alto" => 118,
            "producto_tipo" => "Standard Blue Cell Package",
            "producto_nombre" => "",
            "producto_tipo_terapia" => "",
            "producto_uso_recomendado" => $product_multiplier . " Blue Cell Serum flask a month.",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Standard Package:<br>" . $product_multiplier . " Blue Cell Serum" . $discount_description) .
            $delimiter .
...
$producto6_2 = (object) array(
            ...
            "imagen_ancho" => 150,
            "imagen_alto" => 118,
            "producto_tipo" => "Premium Blue Cell Package",
            "producto_nombre" => "",
            "producto_tipo_terapia" => "",
            "producto_uso_recomendado" => $product_multiplier . "  Blue Cell Serum flasks a month.",
            "producto_precio" => set_precio_str($product_multiplier, 'bluecell', ''),
            "producto_precio_descuento" => set_precio_str($product_multiplier, 'bluecell', '', $porcentaje_descuento),
            "producto_peso" => set_peso($product_multiplier, 2),
            "usar_select" => "",
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Premium Package<br>" . $product_multiplier . " Blue Cell Serum" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'bluecell', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$producto6_3 = (object) array(
            ...
            "imagen_ancho" => 150,
            "imagen_alto" => 118,
            "producto_tipo" => "Optimum Package Blue Cell",
            "producto_nombre" => "",
            "producto_tipo_terapia" => "",
            "producto_uso_recomendado" => $product_multiplier . "  Blue Cell Serum flasks a month.",
            "producto_precio" => set_precio_str($product_multiplier, 'bluecell'),
            ...
            "carrito_enlace" => $cart_link .
            $delimiter .
            rawurlencode("Optimum Package:<br>" . $product_multiplier . " Blue Cell Serum" . $discount_description) .
            $delimiter .
            set_precio($product_multiplier, 'bluecell', '', $porcentaje_descuento) .
            $delimiter .
            $quantity .
...
$producto7_1 = (object) array(
            ...
            "producto_nombre" => "",
            "producto_tipo_terapia" => "",
            "producto_uso_recomendado" => $product_multiplier . " pair Kimi soles",
