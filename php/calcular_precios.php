...
function set_ampollas_gratis($tipo_producto, $descuento = 1)
{
	...
	case 0.95:
            if($tipo_producto == "hp") 
                return "<br>Mas 7 ampollas extra gratis.";
            elseif($tipo_producto == "vp")
		return "<br>Mas 1 MFIII VP (capsulas) extra gratis.";
            else
		return "<br>Mas 4 ampollas extra gratis.";
            break;
	case 0.92:
            if($tipo_producto == "hp")
                return "<br>Mas 11 ampollas extra gratis.";
            else if($tipo_producto == "vp")
		return "<br>Mas 2 MFIII VP (capsulas) extra gratis.";
            else
		return "<br>Mas 5 ampollas extra gratis.";
            break;
	case 0.90:
            if($tipo_producto == "hp")
                return "<br>Mas 14 ampollas extra gratis.";
            elseif($tipo_producto == "vp")
		return "<br>Mas 1 ampolla VP y 1 MFIII VP (capsulas) extra gratis.";
            else
		return "<br>Mas 7 ampollas extra gratis.";
            break;
	case 0.88:
            if($tipo_producto == "hp")
		return "<br>Mas 16 ampollas extra gratis.";
            elseif($tipo_producto == "vp")
		return "<br>Mas 2 ampollas extra gratis.";
            else
		return "<br>Mas 8 ampollas extra gratis.";
            break;
